...
export default function PrivacyPolicyPage() {
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="29 June 2026">
      <LegalHighlight>
        HUMRI is a pro bono legal aid platform. We are committed to protecting
        the privacy and confidentiality of all persons who use our service,
        particularly clients sharing sensitive legal information. Please read
        this policy carefully before submitting a matter.
      </LegalHighlight>

      <LegalSection title="1. Who We Are">
        <LegalP>
          HUMRI (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) is a pro
          bono legal aid platform operating in Nigeria, connecting individuals
          facing legal challenges with qualified volunteer lawyers at no cost.
          Our platform is accessible at https://humri.org.
        </LegalP>
        <LegalP>
          For questions about this Privacy Policy, contact us at:{" "}
          <strong>privacy@humri.ng</strong>
        </LegalP>
      </LegalSection>

      <LegalSection title="2. Information We Collect">
        <LegalP>
          <strong>From clients (matter submission):</strong>
        </LegalP>
        <LegalList
          items={[
        ...
        />
        <LegalP>
          <strong>From volunteer lawyers (registration):</strong>
        </LegalP>
        <LegalList
          items={[
      ...
      <LegalSection title="4. Confidentiality of Legal Matters">
        <LegalHighlight>
          Information you share about your legal matter is treated with the
          strictest confidentiality. It is only accessible to HUMRI
          administrators and the lawyer assigned to your specific matter. No
          other lawyer, staff member, or third party can view the details of
          your submission.
        </LegalHighlight>
        <LegalP>
          HUMRI operates in a manner consistent with the principles of
          solicitor-client privilege under Nigerian law. While HUMRI itself is a
          technology platform and not a law firm, the volunteer lawyers on our
          platform are bound by the Rules of Professional Conduct for Legal
          Practitioners in Nigeria and their duties of confidentiality to
          clients.
        </LegalP>
      </LegalSection>
      ...
      <LegalSection title="5. Legal Basis for Processing">
        <LegalP>
          ...
          applicable Nigerian data protection law (including the Nigeria Data
          Protection Act 2023):
        </LegalP>
        <LegalList
          items={[
      ...
      <LegalSection title="8. Data Security">
        ...
        />
        <LegalP>
          No system is completely secure. In the event of a data breach that may
          affect your rights, we will notify affected individuals and the
          relevant Nigerian authority within 72 hours of becoming aware of the
          breach.
        </LegalP>
      </LegalSection>
      ...
      <LegalSection title="9. Your Rights">
        <LegalP>
          Under the Nigeria Data Protection Act 2023 and other applicable law,
        ...
        <LegalP>
          ...
          <strong>privacy@humri.ng</strong> with your full name and reference
          number (if applicable). We will respond within 30 days.
        </LegalP>
      </LegalSection>

      <LegalSection title="10. Children's Privacy">
        <LegalP>
          HUMRI is not directed at children under 18 years of age. We do not
          knowingly collect personal information from minors. If you believe a
          minor has submitted information to our platform, please contact us
          immediately at privacy@humri.ng and we will take prompt action to
          remove the data.
        </LegalP>
      </LegalSection>
      ...
      <LegalSection title="11. Changes to This Policy">
        <LegalP>
          ...
          For significant changes, we will notify registered lawyers by email.
      ...
      <LegalSection title="12. Contact Us">
        ...
        <LegalP>
          <strong>HUMRI Data Privacy Officer</strong>
          <br />
          Email: privacy@humri.ng
          <br />
          Platform: https://humri.org.
        </LegalP>
        <LegalP>
          You also have the right to lodge a complaint with the Nigeria Data
          Protection Commission (NDPC) at <strong>ndpc.gov.ng</strong> if you
