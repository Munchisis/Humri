...
export default function TermsOfUsePage() {
  return (
    <LegalLayout title="Terms of Use" lastUpdated="29 June 2026">
      <LegalHighlight>
        By accessing or using HUMRI, you agree to be bound by these Terms of
        Use. If you do not agree with any part of these terms, you must not use
        the platform. Please read them carefully.
      </LegalHighlight>

      <LegalSection title="1. About HUMRI">
        <LegalP>
          HUMRI is a digital platform that facilitates access to pro bono (free)
          legal assistance by connecting individuals facing legal challenges
          (&quot;clients&quot;) with qualified volunteer lawyers
          (&quot;lawyers&quot;) in Nigeria. HUMRI itself is a technology
          platform and is not a law firm and does not provide legal advice.
        </LegalP>
        <LegalP>
          The legal services provided through HUMRI are provided solely by the
          individual volunteer lawyers, who are independent professionals
          regulated by the Nigerian Bar Association (NBA) and the Legal
          Practitioners Act (Cap L11, LFN 2004).
        </LegalP>
      </LegalSection>
      ...
      <LegalSection title="2. Eligibility">
        ...
        />
        <LegalP>
          Volunteer lawyers must additionally hold a valid licence to practise
          law in Nigeria, be in good standing with the Nigerian Bar Association,
          and receive approval from a HUMRI administrator before accessing the
          lawyer portal.
        </LegalP>
      </LegalSection>
      ...
      <LegalSection title="3. Nature of the Service">
        <LegalHighlight>
          IMPORTANT: HUMRI is a facilitation platform only. Submitting a matter
          on HUMRI does not guarantee that a lawyer will be assigned or that
          legal representation will be provided. Acceptance of matters is at the
        ...
        <LegalP>
          HUMRI does not guarantee any specific legal outcome. The outcome of
          your matter depends on the facts, applicable law, and the professional
          judgment of your assigned lawyer.
        </LegalP>
      </LegalSection>
      ...
      <LegalSection title="7. Intellectual Property">
        <LegalP>
          The HUMRI platform, including its design, code, branding, and content,
          is owned by HUMRI and is protected by applicable intellectual property
          laws. You are granted a limited, non-exclusive, non-transferable
          licence to use the platform for its intended purpose.
        </LegalP>
        <LegalP>
          Legal documents, submissions, and communications generated through the
          platform in connection with a specific matter belong to the client and
          lawyer involved in that matter.
        </LegalP>
      </LegalSection>

      <LegalSection title="8. Disclaimer of Warranties">
        <LegalP>
          HUMRI is provided on an &quot;as is&quot; and &quot;as available&quot;
          basis without warranties of any kind, express or implied. We do not
          warrant that:
        </LegalP>
        <LegalList
          items={[
      ...
      <LegalSection title="9. Limitation of Liability">
        <LegalP>
          To the maximum extent permitted by Nigerian law, HUMRI shall not be
        ...
        />
        <LegalP>
          HUMRI's total liability to you for any claim arising from use of the
          platform shall not exceed NGN 50,000 (fifty thousand naira).
        </LegalP>
      </LegalSection>

      <LegalSection title="10. Indemnification">
        <LegalP>
          You agree to indemnify, defend, and hold harmless HUMRI, its
          administrators, volunteers, and service providers from and against any
      ...
      <LegalSection title="11. Termination">
        <LegalP>
          HUMRI reserves the right to suspend or terminate access to the
          platform at any time, without notice, for conduct that violates these
          Terms of Use or that we believe is harmful to other users, the
          platform, or third parties.
        </LegalP>
        <LegalP>
          Lawyer accounts may be suspended pending investigation of a complaint
          or professional conduct concern. Suspended lawyers will be notified by
          email.
        </LegalP>
      </LegalSection>
      ...
      <LegalSection title="12. Governing Law and Dispute Resolution">
        <LegalP>
          ...
          the laws of the Federal Republic of Nigeria. Any dispute arising from
          or relating to these terms or your use of HUMRI shall be subject to
          the exclusive jurisdiction of the courts of Nigeria.
        </LegalP>
        <LegalP>
          Before commencing formal legal proceedings, you agree to notify HUMRI
          of the dispute and allow 30 days for informal resolution at
          support@humri.ng.
        </LegalP>
      </LegalSection>
      ...
      <LegalSection title="13. Changes to These Terms">
        <LegalP>
          ...
          continued use of HUMRI after changes are posted constitutes acceptance
          of the revised terms. Registered lawyers will be notified of material
          changes by email.
        </LegalP>
      </LegalSection>
      ...
      <LegalSection title="14. Contact">
        <LegalP>
          ...
          <br />
          <strong>Email:</strong> legal@humri.ng
          <br />
